...
curl -E curl-test-keystore.pem:Jembi#123 -k https://localhost:5000/test/protected
valid=$?

curl -E curl-test-invalid-keystore.pem:Jembi#123 -k https://localhost:5000/test/protected
invalid=$?
