...
/**
 * <p>Java class for PRPA_MT201301UV.Patient complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PRPA_MT201301UV.Patient">
 *   &lt;complexContent>
 ...
 *         &lt;choice>
 *           &lt;element name="patientPerson" type="{urn:hl7-org:v3}PRPA_MT201301UV.Person"/>
 *           &lt;element name="patientNonPersonLivingSubject" type="{urn:hl7-org:v3}PRPA_MT201301UV.NonPersonLivingSubject"/>
 *         &lt;/choice>
 *         &lt;element name="providerOrganization" type="{urn:hl7-org:v3}COCT_MT150003UV03.Organization"/>
 *         &lt;element name="subjectOf" type="{urn:hl7-org:v3}PRPA_MT201301UV.Subject4" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="coveredPartyOf" type="{urn:hl7-org:v3}PRPA_MT201301UV.CoveredParty" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "PRPA_MT201301UV.Patient", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class PRPAMT201301UVPatient {
    ...
    protected JAXBElement<PRPAMT201301UVPerson> patientPerson;
    @XmlElementRef(name = "patientNonPersonLivingSubject", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<PRPAMT201301UVNonPersonLivingSubject> patientNonPersonLivingSubject;
    @XmlElement(required = true, nillable = true)
    protected COCTMT150003UV03Organization providerOrganization;
    @XmlElement(nillable = true)
    protected List<PRPAMT201301UVSubject4> subjectOf;
    @XmlElement(nillable = true)
    protected List<PRPAMT201301UVCoveredParty> coveredPartyOf;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link PRPAMT201301UVPerson }{@code >}
     *     
     */
    public JAXBElement<PRPAMT201301UVPerson> getPatientPerson() {
     ...
     *     
     */
    public void setPatientPerson(JAXBElement<PRPAMT201301UVPerson> value) {
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link PRPAMT201301UVNonPersonLivingSubject }{@code >}
     *     
     */
    public JAXBElement<PRPAMT201301UVNonPersonLivingSubject> getPatientNonPersonLivingSubject() {
     ...
     *     
     */
    public void setPatientNonPersonLivingSubject(JAXBElement<PRPAMT201301UVNonPersonLivingSubject> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201301UVSubject4 }
     * 
     * 
     */
    public List<PRPAMT201301UVSubject4> getSubjectOf() {
        if (subjectOf == null) {
            subjectOf = new ArrayList<PRPAMT201301UVSubject4>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201301UVCoveredParty }
     * 
     * 
     */
    public List<PRPAMT201301UVCoveredParty> getCoveredPartyOf() {
        if (coveredPartyOf == null) {
            coveredPartyOf = new ArrayList<PRPAMT201301UVCoveredParty>();
        }
