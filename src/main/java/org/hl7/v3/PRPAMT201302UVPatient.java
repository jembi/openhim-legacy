...
/**
 * <p>Java class for PRPA_MT201302UV.Patient complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PRPA_MT201302UV.Patient">
 *   &lt;complexContent>
 ...
 *         &lt;choice>
 *           &lt;element name="patientPerson" type="{urn:hl7-org:v3}PRPA_MT201302UV.Person"/>
 *           &lt;element name="patientNonPersonLivingSubject" type="{urn:hl7-org:v3}PRPA_MT201302UV.NonPersonLivingSubject"/>
 *         &lt;/choice>
 *         &lt;element name="providerOrganization" type="{urn:hl7-org:v3}COCT_MT150003UV03.Organization" minOccurs="0"/>
 *         &lt;element name="subjectOf" type="{urn:hl7-org:v3}PRPA_MT201302UV.Subject4" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="coveredPartyOf" type="{urn:hl7-org:v3}PRPA_MT201302UV.CoveredParty" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "PRPA_MT201302UV.Patient", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class PRPAMT201302UVPatient {
    ...
    protected JAXBElement<PRPAMT201302UVPerson> patientPerson;
    @XmlElementRef(name = "patientNonPersonLivingSubject", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<PRPAMT201302UVNonPersonLivingSubject> patientNonPersonLivingSubject;
    ...
    protected List<PRPAMT201302UVSubject4> subjectOf;
    @XmlElement(nillable = true)
    protected List<PRPAMT201302UVCoveredParty> coveredPartyOf;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link PRPAMT201302UVPerson }{@code >}
     *     
     */
    public JAXBElement<PRPAMT201302UVPerson> getPatientPerson() {
     ...
     *     
     */
    public void setPatientPerson(JAXBElement<PRPAMT201302UVPerson> value) {
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link PRPAMT201302UVNonPersonLivingSubject }{@code >}
     *     
     */
    public JAXBElement<PRPAMT201302UVNonPersonLivingSubject> getPatientNonPersonLivingSubject() {
     ...
     *     
     */
    public void setPatientNonPersonLivingSubject(JAXBElement<PRPAMT201302UVNonPersonLivingSubject> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201302UVSubject4 }
     * 
     * 
     */
    public List<PRPAMT201302UVSubject4> getSubjectOf() {
        if (subjectOf == null) {
            subjectOf = new ArrayList<PRPAMT201302UVSubject4>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201302UVCoveredParty }
     * 
     * 
     */
    public List<PRPAMT201302UVCoveredParty> getCoveredPartyOf() {
        if (coveredPartyOf == null) {
            coveredPartyOf = new ArrayList<PRPAMT201302UVCoveredParty>();
        }
