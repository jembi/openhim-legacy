...
/**
 * <p>Java class for PRPA_MT201303UV.Person complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PRPA_MT201303UV.Person">
 *   &lt;complexContent>
 ...
 *         &lt;element name="asPatientOfOtherProvider" type="{urn:hl7-org:v3}PRPA_MT201303UV.PatientOfOtherProvider" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asEmployee" type="{urn:hl7-org:v3}PRPA_MT201303UV.Employee" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asCitizen" type="{urn:hl7-org:v3}PRPA_MT201303UV.Citizen" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asStudent" type="{urn:hl7-org:v3}PRPA_MT201303UV.Student" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asMember" type="{urn:hl7-org:v3}PRPA_MT201303UV.Member" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asOtherIDs" type="{urn:hl7-org:v3}PRPA_MT201303UV.OtherIDs" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="contactParty" type="{urn:hl7-org:v3}PRPA_MT201303UV.ContactParty" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="guardian" type="{urn:hl7-org:v3}PRPA_MT201303UV.Guardian" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="personalRelationship" type="{urn:hl7-org:v3}PRPA_MT201303UV.PersonalRelationship" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="careGiver" type="{urn:hl7-org:v3}PRPA_MT201303UV.CareGiver" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="birthPlace" type="{urn:hl7-org:v3}PRPA_MT201303UV.BirthPlace" minOccurs="0"/>
 *         &lt;element name="guarantorRole" type="{urn:hl7-org:v3}COCT_MT670000UV01.GuarantorRole" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="languageCommunication" type="{urn:hl7-org:v3}PRPA_MT201303UV.LanguageCommunication" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "PRPA_MT201303UV.Person", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class PRPAMT201303UVPerson {
    ...
    protected List<PRPAMT201303UVPatientOfOtherProvider> asPatientOfOtherProvider;
    @XmlElement(nillable = true)
    protected List<PRPAMT201303UVEmployee> asEmployee;
    @XmlElement(nillable = true)
    protected List<PRPAMT201303UVCitizen> asCitizen;
    @XmlElement(nillable = true)
    protected List<PRPAMT201303UVStudent> asStudent;
    @XmlElement(nillable = true)
    protected List<PRPAMT201303UVMember> asMember;
    @XmlElement(nillable = true)
    protected List<PRPAMT201303UVOtherIDs> asOtherIDs;
    @XmlElement(nillable = true)
    protected List<PRPAMT201303UVContactParty> contactParty;
    @XmlElement(nillable = true)
    protected List<PRPAMT201303UVGuardian> guardian;
    @XmlElement(nillable = true)
    protected List<PRPAMT201303UVPersonalRelationship> personalRelationship;
    @XmlElement(nillable = true)
    protected List<PRPAMT201303UVCareGiver> careGiver;
    @XmlElementRef(name = "birthPlace", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<PRPAMT201303UVBirthPlace> birthPlace;
    @XmlElement(nillable = true)
    protected List<COCTMT670000UV01GuarantorRole> guarantorRole;
    @XmlElement(nillable = true)
    protected List<PRPAMT201303UVLanguageCommunication> languageCommunication;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UVPatientOfOtherProvider }
     * 
     * 
     */
    public List<PRPAMT201303UVPatientOfOtherProvider> getAsPatientOfOtherProvider() {
        if (asPatientOfOtherProvider == null) {
            asPatientOfOtherProvider = new ArrayList<PRPAMT201303UVPatientOfOtherProvider>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UVEmployee }
     * 
     * 
     */
    public List<PRPAMT201303UVEmployee> getAsEmployee() {
        if (asEmployee == null) {
            asEmployee = new ArrayList<PRPAMT201303UVEmployee>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UVCitizen }
     * 
     * 
     */
    public List<PRPAMT201303UVCitizen> getAsCitizen() {
        if (asCitizen == null) {
            asCitizen = new ArrayList<PRPAMT201303UVCitizen>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UVStudent }
     * 
     * 
     */
    public List<PRPAMT201303UVStudent> getAsStudent() {
        if (asStudent == null) {
            asStudent = new ArrayList<PRPAMT201303UVStudent>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UVMember }
     * 
     * 
     */
    public List<PRPAMT201303UVMember> getAsMember() {
        if (asMember == null) {
            asMember = new ArrayList<PRPAMT201303UVMember>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UVOtherIDs }
     * 
     * 
     */
    public List<PRPAMT201303UVOtherIDs> getAsOtherIDs() {
        if (asOtherIDs == null) {
            asOtherIDs = new ArrayList<PRPAMT201303UVOtherIDs>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UVContactParty }
     * 
     * 
     */
    public List<PRPAMT201303UVContactParty> getContactParty() {
        if (contactParty == null) {
            contactParty = new ArrayList<PRPAMT201303UVContactParty>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UVGuardian }
     * 
     * 
     */
    public List<PRPAMT201303UVGuardian> getGuardian() {
        if (guardian == null) {
            guardian = new ArrayList<PRPAMT201303UVGuardian>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UVPersonalRelationship }
     * 
     * 
     */
    public List<PRPAMT201303UVPersonalRelationship> getPersonalRelationship() {
        if (personalRelationship == null) {
            personalRelationship = new ArrayList<PRPAMT201303UVPersonalRelationship>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UVCareGiver }
     * 
     * 
     */
    public List<PRPAMT201303UVCareGiver> getCareGiver() {
        if (careGiver == null) {
            careGiver = new ArrayList<PRPAMT201303UVCareGiver>();
        }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link PRPAMT201303UVBirthPlace }{@code >}
     *     
     */
    public JAXBElement<PRPAMT201303UVBirthPlace> getBirthPlace() {
        return birthPlace;
    }
     ...
     *     
     */
    public void setBirthPlace(JAXBElement<PRPAMT201303UVBirthPlace> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UVLanguageCommunication }
     * 
     * 
     */
    public List<PRPAMT201303UVLanguageCommunication> getLanguageCommunication() {
        if (languageCommunication == null) {
            languageCommunication = new ArrayList<PRPAMT201303UVLanguageCommunication>();
        }
