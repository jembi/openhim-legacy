...
/**
 * <p>Java class for PRPA_MT201301UV.Person complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PRPA_MT201301UV.Person">
 *   &lt;complexContent>
 ...
 *         &lt;element name="asPatientOfOtherProvider" type="{urn:hl7-org:v3}PRPA_MT201301UV.PatientOfOtherProvider" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asEmployee" type="{urn:hl7-org:v3}PRPA_MT201301UV.Employee" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asCitizen" type="{urn:hl7-org:v3}PRPA_MT201301UV.Citizen" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asStudent" type="{urn:hl7-org:v3}PRPA_MT201301UV.Student" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asMember" type="{urn:hl7-org:v3}PRPA_MT201301UV.Member" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asOtherIDs" type="{urn:hl7-org:v3}PRPA_MT201301UV.OtherIDs" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="contactParty" type="{urn:hl7-org:v3}PRPA_MT201301UV.ContactParty" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="guardian" type="{urn:hl7-org:v3}PRPA_MT201301UV.Guardian" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="personalRelationship" type="{urn:hl7-org:v3}PRPA_MT201301UV.PersonalRelationship" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="careGiver" type="{urn:hl7-org:v3}PRPA_MT201301UV.CareGiver" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="birthPlace" type="{urn:hl7-org:v3}PRPA_MT201301UV.BirthPlace" minOccurs="0"/>
 *         &lt;element name="guarantorRole" type="{urn:hl7-org:v3}COCT_MT670000UV01.GuarantorRole" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="languageCommunication" type="{urn:hl7-org:v3}PRPA_MT201301UV.LanguageCommunication" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{urn:hl7-org:v3}InfrastructureRootAttributes"/>
 *       &lt;attribute name="nullFlavor" type="{urn:hl7-org:v3}NullFlavor" />
 *       &lt;attribute name="classCode" type="{urn:hl7-org:v3}cs" fixed="PSN" />
...
@XmlType(name = "PRPA_MT201301UV.Person", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class PRPAMT201301UVPerson {
    ...
    protected List<PRPAMT201301UVPatientOfOtherProvider> asPatientOfOtherProvider;
    @XmlElement(nillable = true)
    protected List<PRPAMT201301UVEmployee> asEmployee;
    @XmlElement(nillable = true)
    protected List<PRPAMT201301UVCitizen> asCitizen;
    @XmlElement(nillable = true)
    protected List<PRPAMT201301UVStudent> asStudent;
    @XmlElement(nillable = true)
    protected List<PRPAMT201301UVMember> asMember;
    @XmlElement(nillable = true)
    protected List<PRPAMT201301UVOtherIDs> asOtherIDs;
    @XmlElement(nillable = true)
    protected List<PRPAMT201301UVContactParty> contactParty;
    @XmlElement(nillable = true)
    protected List<PRPAMT201301UVGuardian> guardian;
    @XmlElement(nillable = true)
    protected List<PRPAMT201301UVPersonalRelationship> personalRelationship;
    @XmlElement(nillable = true)
    protected List<PRPAMT201301UVCareGiver> careGiver;
    @XmlElementRef(name = "birthPlace", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<PRPAMT201301UVBirthPlace> birthPlace;
    @XmlElement(nillable = true)
    protected List<COCTMT670000UV01GuarantorRole> guarantorRole;
    @XmlElement(nillable = true)
    protected List<PRPAMT201301UVLanguageCommunication> languageCommunication;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201301UVPatientOfOtherProvider }
     * 
     * 
     */
    public List<PRPAMT201301UVPatientOfOtherProvider> getAsPatientOfOtherProvider() {
        if (asPatientOfOtherProvider == null) {
            asPatientOfOtherProvider = new ArrayList<PRPAMT201301UVPatientOfOtherProvider>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201301UVEmployee }
     * 
     * 
     */
    public List<PRPAMT201301UVEmployee> getAsEmployee() {
        if (asEmployee == null) {
            asEmployee = new ArrayList<PRPAMT201301UVEmployee>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201301UVCitizen }
     * 
     * 
     */
    public List<PRPAMT201301UVCitizen> getAsCitizen() {
        if (asCitizen == null) {
            asCitizen = new ArrayList<PRPAMT201301UVCitizen>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201301UVStudent }
     * 
     * 
     */
    public List<PRPAMT201301UVStudent> getAsStudent() {
        if (asStudent == null) {
            asStudent = new ArrayList<PRPAMT201301UVStudent>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201301UVMember }
     * 
     * 
     */
    public List<PRPAMT201301UVMember> getAsMember() {
        if (asMember == null) {
            asMember = new ArrayList<PRPAMT201301UVMember>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201301UVOtherIDs }
     * 
     * 
     */
    public List<PRPAMT201301UVOtherIDs> getAsOtherIDs() {
        if (asOtherIDs == null) {
            asOtherIDs = new ArrayList<PRPAMT201301UVOtherIDs>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201301UVContactParty }
     * 
     * 
     */
    public List<PRPAMT201301UVContactParty> getContactParty() {
        if (contactParty == null) {
            contactParty = new ArrayList<PRPAMT201301UVContactParty>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201301UVGuardian }
     * 
     * 
     */
    public List<PRPAMT201301UVGuardian> getGuardian() {
        if (guardian == null) {
            guardian = new ArrayList<PRPAMT201301UVGuardian>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201301UVPersonalRelationship }
     * 
     * 
     */
    public List<PRPAMT201301UVPersonalRelationship> getPersonalRelationship() {
        if (personalRelationship == null) {
            personalRelationship = new ArrayList<PRPAMT201301UVPersonalRelationship>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201301UVCareGiver }
     * 
     * 
     */
    public List<PRPAMT201301UVCareGiver> getCareGiver() {
        if (careGiver == null) {
            careGiver = new ArrayList<PRPAMT201301UVCareGiver>();
        }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link PRPAMT201301UVBirthPlace }{@code >}
     *     
     */
    public JAXBElement<PRPAMT201301UVBirthPlace> getBirthPlace() {
        return birthPlace;
    }
     ...
     *     
     */
    public void setBirthPlace(JAXBElement<PRPAMT201301UVBirthPlace> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201301UVLanguageCommunication }
     * 
     * 
     */
    public List<PRPAMT201301UVLanguageCommunication> getLanguageCommunication() {
        if (languageCommunication == null) {
            languageCommunication = new ArrayList<PRPAMT201301UVLanguageCommunication>();
        }
