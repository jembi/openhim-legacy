...
/**
 * <p>Java class for PRPA_MT201303UV.Patient complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PRPA_MT201303UV.Patient">
 *   &lt;complexContent>
 ...
 *         &lt;choice>
 *           &lt;element name="patientPerson" type="{urn:hl7-org:v3}PRPA_MT201303UV.Person"/>
 *           &lt;element name="patientNonPersonLivingSubject" type="{urn:hl7-org:v3}PRPA_MT201303UV.NonPersonLivingSubject"/>
 *         &lt;/choice>
 *         &lt;element name="providerOrganization" type="{urn:hl7-org:v3}COCT_MT150003UV03.Organization" minOccurs="0"/>
 *         &lt;element name="subjectOf" type="{urn:hl7-org:v3}PRPA_MT201303UV.Subject4" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="coveredPartyOf" type="{urn:hl7-org:v3}PRPA_MT201303UV.CoveredParty" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "PRPA_MT201303UV.Patient", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class PRPAMT201303UVPatient {
    ...
    protected JAXBElement<PRPAMT201303UVPerson> patientPerson;
    @XmlElementRef(name = "patientNonPersonLivingSubject", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<PRPAMT201303UVNonPersonLivingSubject> patientNonPersonLivingSubject;
    ...
    protected List<PRPAMT201303UVSubject4> subjectOf;
    @XmlElement(nillable = true)
    protected List<PRPAMT201303UVCoveredParty> coveredPartyOf;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link PRPAMT201303UVPerson }{@code >}
     *     
     */
    public JAXBElement<PRPAMT201303UVPerson> getPatientPerson() {
     ...
     *     
     */
    public void setPatientPerson(JAXBElement<PRPAMT201303UVPerson> value) {
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link PRPAMT201303UVNonPersonLivingSubject }{@code >}
     *     
     */
    public JAXBElement<PRPAMT201303UVNonPersonLivingSubject> getPatientNonPersonLivingSubject() {
     ...
     *     
     */
    public void setPatientNonPersonLivingSubject(JAXBElement<PRPAMT201303UVNonPersonLivingSubject> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UVSubject4 }
     * 
     * 
     */
    public List<PRPAMT201303UVSubject4> getSubjectOf() {
        if (subjectOf == null) {
            subjectOf = new ArrayList<PRPAMT201303UVSubject4>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT201303UVCoveredParty }
     * 
     * 
     */
    public List<PRPAMT201303UVCoveredParty> getCoveredPartyOf() {
        if (coveredPartyOf == null) {
            coveredPartyOf = new ArrayList<PRPAMT201303UVCoveredParty>();
        }
