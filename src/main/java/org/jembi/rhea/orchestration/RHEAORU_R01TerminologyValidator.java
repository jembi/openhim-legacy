...
public class RHEAORU_R01TerminologyValidator implements Callable {
	...
	public Object onCall(MuleEventContext eventContext) throws Exception {
		...
		validateTerminologyInORU_R01(oru_r01_str, client);
		
		return msg;
	}
	
	protected void validateTerminologyInORU_R01(String oru_r01_str, MuleClient client) throws Exception {
		...
		for (int j = 0 ; j < reps ; j++) {
			...
			for (int i = 0 ; i < observations.getOBSERVATIONReps() ; i++) {
				...
				if (!dispatchToFlow(client, namespace, id)) {
	...
	protected  boolean dispatchToFlow(MuleClient client, String namespace, String code) throws MuleException {
